      ...
      <div>
        <div className="background bg-[#01321f] pl-[100px] pr-[100px]">
          <div className="max-w-full w-[1920px] m-auto grid grid-cols-3 pt-[20px] gap-[20px]  ">
            ...
            <div className=" px-[16px] mr-5 ">
              <h4 className="text-[#FFFFFF]">HỆ THỐNG THẨM MỸ TUYẾN SPA</h4>
              <p className="text-[25px] text-[#E7C55A]">TẠI HẢI DƯƠNG</p>
              <div>
                <p className="text-[16px] text-[#FFFFFF] px-[40px] mb-[5px]">
                  THẨM MỸ VIỆN TUYẾN SPA cơ sở 1
                </p>
                <p className="text-[13px] text-[#FFFFFF] px-[40px]">
              ...
              <p className="text-[25px] text-[#E7C55A]">TẠI HÀ NỘI</p>
              <div>
                <p className="text-[16px] text-[#FFFFFF] px-[40px] mb-[5px]">
                  THẨM MỸ VIỆN TUYẾN SPA
                </p>
