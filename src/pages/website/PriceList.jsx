          ...
          <div className="w-[75%] pr-10">
            <div className>
              ...
              <p className="pt-[23px] pb-[15px] text-base">
                Lời đầu tiên, cho phép <strong>Tuyến Spa</strong> được gửi tới
              ...
              <p className="pt-[23px] pb-[15px] text-base">
                ...
                <strong>Tuyến Spa</strong> đã dần chinh phục khách hàng với
                những dịch vụ thiết kế sáng tạo uy tín và chất lượng.
              </p>
              <p className="text-base">
                Tự tin với khả năng đáp ứng mọi yêu cầu thiết kế của khách hàng,{" "}
                <strong>Tuyến Spa</strong> chính thức đem lại dịch vụ Sự ủng hộ
                và tin tưởng của khách hàng sẽ trở thành nguồn cảm hứng lớn lao
                cho <strong>Tuyến Spa</strong> trong quá trình phác họa những ý
            ...
            <p className="mt-5 text-base">
              ...
              <strong className="text-[#036636]">Tuyến Spa</strong> về dịch vụ
              cắt mí mắt.
            </p>
          </div>
          <SideBar />
