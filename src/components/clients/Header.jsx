...
const Header = () => {
  ...
  const checkButton = () => {
    ...
    if (ismolDal === "signin") {
      return <SignIn />
    } else if (ismolDal === "signup") {
      return <SignUp />
    }else if (ismolDal === "booking") {
      return <BookingPage />
    }
  }
            ...
            <nav>
              <div className=" flex">
                ...
                <div className="flex-auto">
                  ...
                  <button data="booking" onClick={showModal} className=" mx-3 rounded-md bg-[#003C21] text-[#fff] border-2 border-emerald-500 px-3" >Đặt lịch</button>
                </div>
              </div>
            </nav>
          </div>
